        ...
        <v-col cols="12" sm="11" md="8" lg="6" xl="4" >
          ...
          <v-form ref="form" v-model="valid" > 
            <v-row justify="center" >
              ...
              <v-col cols="12">
               <v-textarea
                  v-model="causa" outlined  label="Causas" rows="3" hide-details  class="text-h6" :rules="causaRules"
...
export default {
  data:()=>({
    ...
    horamodal2 : false,
    tipo       : { id:null, nombre:''},
    tipos      : [{ id:1, nombre:'Mantenimiento 1'},{id:2, nombre:'Mantenimiento 2'}],
    depto      : { id:null, nombre:''},
    deptos     : [{ id:1, nombre: 'FLEXO'},{id:2, nombre:'BORDADOS'}],
    maquina    : {id:null, nombre:''},
    maquinas   : [ {id:1, nombre:"Maquina 1"},{id:2, nombre:"Maquina 2"},{id:3, nombre:"Maquina 3"},{id:4, nombre:"Maquina 4"},],
    causa      : '',
    contramedida       :'',
